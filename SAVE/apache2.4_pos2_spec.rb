...
# INCLUDE VARS HERE
#####################
service_name = "httpd2.4_pos2"
listen_port_http = "28163"
listen_port_https = "28443"
...
# MaxRequestsWorkers
describe command( "grep -Ec '^\s*MaxRequestWorkers\s*800$' /etc/#{service_name}/conf/extra/httpd-mpm.conf" ) do
  its( :stdout ) { should match /^1$/ }
end
